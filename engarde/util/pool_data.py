data = {
    ...
    "pools": [
        ...
        {
            "pool_no": "Pool #3", "fencers": [
                {"name": " Harris, Max : ",         "pool_pos": "1", "results": ["D3", "D2", "D1", "V5"]},
                {"name": " Pimenov II, A Kelly : ", "pool_pos": "2", "results": ["V5", "D1", "D1", "V5"]},
                {"name": " Vo, Minh : ",            "pool_pos": "3", "results": ["V5", "V5", "D3", "V5"]},
                {"name": " Xu, Ellen : ",           "pool_pos": "4", "results": ["V5", "V5", "V5", "V5"]},
                {"name": " Gannon, Kayden : ",      "pool_pos": "5", "results": ["D2", "D2", "D3", "D0"]}
            ]
        }
    ]
}